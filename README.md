"Analysis on US Accidents"

Data Visualisation Project by Laura Ehlert Moreno
DHBW Stuttgart | wi23171@lehre.dhbw-stuttgart.de | WWI2023F 
Florian Eichin
...
1.  Die Datenbereinigung, -transformation und Visualisierungen wurden mithilfe eines Jupyter Notebooks erstellt, welches sich im Ordner 'jupyter_notebook_accidents' befindet. In demselben Ordner befinden sich außerdem:
    ...
    - unter html-figures: alle Visualisierungen in HTML-Format (im Falle dass das Dashboard nicht laden sollte)

2.  Anschließend wurde ein dashboard gebaut, dessen Elemente unter src/components zu finden sind.
    - ids: Für einheitlichen Callback
